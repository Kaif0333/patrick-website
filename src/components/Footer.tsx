        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-16 mb-24">
          <div className="lg:col-span-4">
            ...
            <div className="flex gap-6">
                <Link className="w-10 h-10 border border-slate-700 flex items-center justify-center rounded hover:bg-[#0A66C2] hover:border-[#0A66C2] hover:text-white transition-all text-slate-400 group" to="https://www.linkedin.com/in/pcoyle/" target="_blank">
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="space-y-4 text-xs font-bold uppercase tracking-widest">
                <li><Link className="hover:text-white transition-colors" to="/services/financial-navigation">Navigation</Link></li>
                <li><Link className="hover:text-white transition-colors" to="/services/financial-transformation">Transformation</Link></li>
                <li><Link className="hover:text-white transition-colors" to="/services/life-science-advisory">Life Science</Link></li>
                <li><Link className="hover:text-white transition-colors" to="/services">All Services</Link></li>
            </ul>
          </div>
          <div className="lg:col-span-2">
            <h4 className="text-xs font-black uppercase tracking-[0.2em] text-white mb-8">Training</h4>
            <ul className="space-y-4 text-xs font-bold uppercase tracking-widest">
                <li><Link className="hover:text-white transition-colors" to="/training/patients-profitability">Patients &amp; Profit</Link></li>
                <li><Link className="hover:text-white transition-colors" to="/training/rising">Leadership</Link></li>
                <li><Link className="hover:text-white transition-colors" to="/training/fundamentals">Fundamentals</Link></li>
                <li><Link className="hover:text-white transition-colors" to="/training">All Academy</Link></li>
            </ul>
          </div>
          <div className="lg:col-span-4">
