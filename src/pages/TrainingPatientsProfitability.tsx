...
function TrainingPatientsProfitability() {
  return (
    <>
...
<a className="inline-flex items-center gap-3 text-primary font-bold group" href="/contact">
                            Connect on LinkedIn
...
export default TrainingPatientsProfitability;